		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 text-center">
					<img class="productos-principal" src="imgs/assets/p1.jpg" alt="">
					<h4>Rimbombin</h4>
				</div>
				<div class="col-md-3 text-center">
					<img class="productos-principal" src="imgs/assets/p2.jpg" alt="">
					<h4>Chupilita</h4>
				</div>
				<div class="col-md-3 text-center">
					<img class="productos-principal" src="imgs/assets/p3.jpg" alt="">
					<h4>Chicles</h4>
				</div>
				<div class="col-md-3 text-center">
					<img class="productos-principal" src="imgs/assets/p4.jpg" alt="">
					<h4>Caramelos</h4>
				</div>
			</div>
		</div>

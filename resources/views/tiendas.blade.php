...
<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				<h1>Tiendas</h1>
				<p><a href="/Candy-ucab-/public/">Inicio</a> > Tiendas</p>
			</div>
		</div>
	</div>
				...
				<div class="row">
					<div class="col-md-4 ">
						<div class="contenedor-tienda">
							...
							<p class="texto-tienda">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo nesciunt voluptatum, iusto magnam, maxime omnis.</p>
						</div>
					</div>
					<div class="col-md-4 ">
						<div class="contenedor-tienda">
